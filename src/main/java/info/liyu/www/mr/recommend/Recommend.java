...
public class Recommend {
    public static void main(String[] args) throws InterruptedException, IOException, ClassNotFoundException, URISyntaxException {
        ...
        JobInitModel userScoreMatrixJob = new JobInitModel(new String[]{userScoreMatrixInpath}, userScoreMatrixOutpath
                , conf, null, "CalcUserScoreMatrix", Recommend.class, null, info.xiaohei.www.mr.recommend.UserScoreMatrixMapper.class, Text.class, Text.class
                , null, null, info.xiaohei.www.mr.recommend.UserScoreMatrixReducer.class, Text.class, Text.class);
        ...
        JobInitModel itermOccurrenceMatrixJob = new JobInitModel(new String[]{userScoreMatrixOutpath}, itermOccurrenceOutpath
                , conf, null, "CalcItermOccurrenceMatrix", Recommend.class, null, info.xiaohei.www.mr.recommend.ItermOccurrenceMapper.class, Text.class, IntWritable.class
                , null, null, info.xiaohei.www.mr.recommend.ItermOccurrenceReducer.class, Text.class, IntWritable.class);
        ...
        if (args[0].equals("0")) {
            ...
            JobInitModel recommendJob = new JobInitModel(new String[]{userScoreMatrixOutpath}
                    , recommendOutpath, conf, job, "recommend", Recommend.class, null, info.xiaohei.www.mr.recommend.RecommendMapper.class, Text.class, DoubleWritable.class
                    , null, null, info.xiaohei.www.mr.recommend.RecommendReducer.class, Text.class, Text.class);
