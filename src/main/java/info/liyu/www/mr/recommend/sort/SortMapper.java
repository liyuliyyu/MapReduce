 ...
 * 对推荐结果进排序
 */
public class SortMapper extends Mapper<LongWritable, Text, info.xiaohei.www.mr.recommend.sort.SortData, NullWritable> {
    info.xiaohei.www.mr.recommend.sort.SortData sortData = new info.xiaohei.www.mr.recommend.sort.SortData();
